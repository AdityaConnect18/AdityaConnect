...
export default function Bar3(props) {
    return(
        <div className={classes.MainCon}>
            <div className={classes.Head}>
                <div className={classes.TdHead}>Departments</div> 
            </div>
            ...
            </div>
            {
                ...
                <div className={classes.Data}>
                    <div className={classes.BoxLeft} key={my._id} >
                        <div className={classes.Td}>{index + 1}</div>
                        <div className={classes.Td}>{my.deptName}</div>
                    </div>
