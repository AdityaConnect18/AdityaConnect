  ...
  return (
    <div className={classes.Userbox} key={props.data._id}>
      ...
      <div className={classes.BelowButton}>
        ...
        <Button className={classes.Update} onClick={props.password}>
          <GoKey className={classes.Buttonicon2} />
          Update Password
        </Button>
        <Button className={classes.Remove} onClick={props.del}>
