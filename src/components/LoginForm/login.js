  ...
  return (
    <>
      <div className={classes.Container}>
        ...
        <hr />
        <p className={classes.BelowTop}>
          <MdLiveHelp className={classes.Help} />
          Help & Support
        </p>
        <p className={classes.BelowContent}>
          For help to use this application, you can contact Campusnet Team.
        </p>
      </div>
    </>
  );
